...
<html>
  <head>
    ...
    <script type="text/javascript">
           ...
           function jinrubanke(id)
           {
               window.location.href="<%=path %>/zuoye?type=ShowZuoYe&bianhao="+id;
           }
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						...
						<c:choose>
							...
							<c:when test="${banke.judge==1}"><input type="button" value="删除" onclick="teaDel(${banke.bianhao})"/></c:when>
							<c:when test="${banke.judge==2}"><input type="button" value="进入" onclick="jinrubanke(${banke.bianhao})"/></c:when>
							<c:when test="${banke.judge==3}"><input type="button" value="进入" onclick="jinrubanke2(${banke.bianhao})"/></c:when>
						</c:choose>
					</td>
				</tr>
				</c:forEach>
