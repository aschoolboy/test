...
<html>
  <head>
    ...
    <script type="text/javascript">
            ...
            {
               var url="<%=path %>/updown/updown.jsp?fujianPath="+fujianPath+"&fujianYuashiMing="+fujianYuasMing;
		       url=encodeURI(url); 
               url=encodeURI(url); 
           ...
           function jinrubanke(bk_id)
           {
               window.location.href="<%=path %>/zuoye?type=ShowZuoYe_stu&bianhao="+bk_id;
           }
           ...
           function yixuanbanke(){
           	window.location.href="<%=path %>/zuoye?type=ShowZuoYe";
           }
       </script>
	...
	<div class="wrap"> 
        ...
        <TABLE class=MainTable style="MARGIN-TOP: 0px" cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="33" background="<%=path %>/img/tbg.gif">&nbsp;班课<%=session.getAttribute("stu_id") %>信息管理&nbsp;</td>
				</tr>
				<tr align="center" bgcolor="#FAFAF1" height="22">
					<td width="20%">班课编号</td>
					<td width="20%">班课名称</td>
					<td width="20%">教师</td>
					<td width="20%">创<%=session.getAttribute("stu_id") %>建时间</td>
					<td width="20%">操<%String stu_id=(String)session.getAttribute("stu_id"); %>作<%=stu_id %></td>
		        </tr>
		        
				<c:forEach items="${requestScope.bankeList1}" var="banke">
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						...
						<input type="button" value="进入" onclick="jinrubanke(${banke.bianhao},<%=stu_id %>)"/>
					</td>
				</tr>
				</c:forEach>
			</table>
