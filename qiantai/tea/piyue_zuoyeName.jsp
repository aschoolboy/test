...
<html>
  <head>
    ...
    <script type="text/javascript">
            ...
            function check11(id)
           {
           	   window.location.href = "<%=path %>/qiantai/zuoyestu/zuoyestu_tijiao.jsp?zuoyeID="+id;
               
           }
           function piyue(id)
           {
            	var url="<%=path %>/qiantai/zuoye/piyueneirong.jsp?id="+id;
			    var targetWinName="newWin";
				var features="width=100 ,height=100 ,toolbar=no, top=0, left=0, menubar=no, scrollbars=no, resizable=no,location=no, status=no"
								...
								<TR align="left" height="500">
									<TD>
									    <table width="99%" border="0" cellpadding="5" cellspacing="5" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
											  ...
											  <c:forEach items="${requestScope.zuoyeList_stu}" var="zuoye_stu">
											  <tr align='center' bgcolor="#FFFFFF" height="22">
												  <td>${zuoye_stu.mingcheng}</td>
												  <td>${zuoye_stu.fujianYuanshiming}</td>
												  <td>${zuoye_stu.stu.name1}</td>
												  <td>
												     <a href="#" onclick="down1('${zuoye_stu.fujian}','${zuoye_stu.fujianYuanshiming}')" style="font-size: 11px;color: red">下载</a>
												     <a href="#" onclick="piyue(${zuoye_stu.id})" style="font-size: 11px;color: red">评阅</a>
												  </td>
											  </tr>
											  </c:forEach>
				        			    </table>
