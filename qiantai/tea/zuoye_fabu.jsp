									...
									<TD>
									    ...
									    <table width="99%" border="0" cellpadding="9" cellspacing="9">
								                ...
								                <tr align='center'>
												    ...
												    <td width="85%" bgcolor="#FFFFFF" align="left">
												        <!--<input type="text" name="suoshubankebianhao" size="40"/>
												    -->
												    	<select name="bk_name" style="width: 70px">
                               								<%
		        												db.getCon();
																String sql="select * from t_banke where bk_owner = " + session.getAttribute("tea_id");
												...
												<tr>
												    	<td width="15%" bgcolor="#FFFFFF" align="center">截至日期：</td><td><input type="date" name="date"/></td>
												    </tr>
												<tr align='center'>
												    <td width="15%" bgcolor="#FFFFFF" align="center">
												        &nbsp;
