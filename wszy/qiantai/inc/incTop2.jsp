...
<html>
  ...
  <body>
       ...
       <a href="<%=path %>/qiantai/tea/zuoye_fabu.jsp">发布作业</A> &nbsp;&nbsp;
       <a href="<%=path %>/zuoye?type=zuoye_mana">作业管理</A> &nbsp;&nbsp;
       <a href="<%=path %>/banke?type=tea_piyue_bkname">批阅作业</A> &nbsp;&nbsp;
       
       <a href="<%=path %>/banke?type=bankeMana&tea_id=<%=session.getAttribute("tea_id") %>">教师班课</A> &nbsp;&nbsp;
       </c:if>
       
       
       <c:if test="${sessionScope.userType!=null && sessionScope.userType==2}">
       <a href="<%=path %>/banke?type=ziliao_all">下载教学文档</A> &nbsp;&nbsp;
       <a href="<%=path %>/banke?type=zuoye_all">我的作业</A> &nbsp;&nbsp;
<!--        <a href="<%=path %>/qiantai/zuoyestu/zuoyestu_tijiao.jsp">提交作业</A> &nbsp;&nbsp; -->
       <!-- 
       <a href="<%=path %>/qiantai/zuoye/banke_mana.jsp">学生选课</A> &nbsp;&nbsp;
        -->
        <a href="<%=path %>/bankestu?type=bankeStuMana">学生选课</A> &nbsp;&nbsp;
       </c:if>
