									...
									<TD>
									    ...
									    <table width="99%" border="0" cellpadding="9" cellspacing="9">
								                <tr align='center'>
												    ...
												    <input type="hidden" name="zuoyeID" value="<%=request.getParameter("zuoyeID") %>" />
												       作业附件：
												    </td>
												    <td width="85%" bgcolor="#FFFFFF" align="left">
												        ...
												        <input type="hidden" name="zuoyeID" id="zuoyeID" value="<%=request.getParameter("zuoyeID") %>"/>
												    </td>
												</tr>
												<tr align='center'>
												    <td width="15%" bgcolor="#FFFFFF" align="center">
												    ...
												    <td width="85%" bgcolor="#FFFFFF" align="left">
												       <input type="button" value="提交" onclick="check11(<%=request.getParameter("zuoyeID") %>)"/>&nbsp; 
				        			    ...
				        			    <%DB mydb = new DB();
				        			    String sql="select * from t_zuoyestu where zuoye_id="+request.getParameter("zuoyeID")+" and stu_id="+session.getAttribute("stu_id");
				        			    ResultSet rs = mydb.select(sql);
				        			    while(rs.next()){
				        			    	%>批阅内容：<%=rs.getString("piyueneirong") %><br />
				        			    	得分：<%=rs.getInt("piyuefenzhi")%><%
				        			    }
