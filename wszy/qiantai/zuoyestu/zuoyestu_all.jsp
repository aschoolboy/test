									...
									<TD>
									    <table width="99%" border="0" cellpadding="5" cellspacing="5" bgcolor="#FFFFFF" align="center" style="margin-top:8px">
											  ...
											  <tr align='center' bgcolor="#FFFFFF" height="22">
												  ...
												  <td>
												      <a style="color: red" href="#" onclick="zuoyestu_pingyue(${zuoyestu.id})">评阅</a>
                                                  </td>
											  </tr>
											  </c:forEach>
				        			    -->
				        			    <%
		        db.getCon();
				String sql="select * from t_banke,t_tea where t_banke.bk_owner = " + session.getAttribute("tea_id") + " and t_banke.bk_owner = t_tea.id";
				ResultSet rs=db.select(sql);
		        while(rs.next()){
		        %><tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		        <td bgcolor="#FFFFFF" align="center">
		        <%=rs.getString("t_banke.bk_id") %></td>
		        <td bgcolor="#FFFFFF" align="center">
		        <%=rs.getString("t_banke.bk_name") %></td>
		        <td bgcolor="#FFFFFF" align="center">
		        <%=rs.getString("t_tea.name") %></td>
		        <td bgcolor="#FFFFFF" align="center">
		        <%=rs.getString("t_banke.bk_time") %></td>
		        <td bgcolor="#FFFFFF" align="center">
						<input type="button" value="删除" onclick="teaDel(<%=rs.getInt("bk_ID")%>)"/>
					</td></tr>
		        <%
		        }
		         %></table>
